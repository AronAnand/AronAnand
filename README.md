...
![AI](https://img.shields.io/badge/Agentic-AI-blue?style=flat-square&logo=ai&labelColor=1a1a1a)
...
<details open>
<summary><b>🎲 AI-Powered Matchmaking Platform</b></summary>
<br>
```yaml
Tech Stack:
  Backend: LangChain, FastAPI, Python
  Vector DB: Pinecone
...
<details>
<summary><b>📚 Enterprise RAG Framework</b></summary>
<br>
```yaml
Architecture:
...
Scale:
  Documents: 1M+
  Latency: <200ms P95
  Accuracy: 94% on internal benchmarks
...
<details>
<summary><b>⚙️ LLM Evaluation Suite</b></summary>
<br>
```yaml
Metrics:
...
<a href="https://leetcode.com/u/Aron-droid/">
  <img src="https://img.shields.io/badge/LeetCode-Solve_Together-FFA116?style=for-the-badge&logo=leetcode&logoColor=white" alt="LeetCode" />
</a>
...
```typescript
const interests = {
  seeking: ["LLM Research", "AI Product Development", "Hackathon Teams"],
  focus: ["Agentic AI", "RAG Systems", "Prompt Engineering"],
